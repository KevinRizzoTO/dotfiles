...
lvim.keys.normal_mode["<Leader>dd"] = '"+dd'
...
lvim.keys.visual_mode["<Leader>dd"] = '"+dd'

lvim.keys.normal_mode["c"] = '"_c'
lvim.keys.normal_mode["C"] = '"_C'
lvim.keys.normal_mode["cc"] = '"_cc'
lvim.keys.normal_mode["<leader>cc"] = '"+cc'

lvim.keys.visual_mode["c"] = '"_c'
lvim.keys.visual_mode["C"] = '"_C'
lvim.keys.visual_mode["cc"] = '"_cc'
lvim.keys.visual_mode["<leader>cc"] = '"+cc'
...
require("lvim.lsp.manager").setup("sorbet", {})

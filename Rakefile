...
namespace 'packages' do
  ...
  task :nvim do
    sh_swallow('wget -P /tmp https://github.com/neovim/neovim/releases/download/v0.8.0/nvim-linux64.tar.gz && mkdir /tmp/nvim && tar -xzvf /tmp/nvim-linux64.tar.gz -C /tmp/nvim/ && sudo mv /tmp/nvim/nvim-linux64/bin/nvim /usr/bin/nvim')
  end
